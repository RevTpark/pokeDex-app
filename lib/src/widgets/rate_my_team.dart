...
class _RateMyTeamDisplayState extends State<RateMyTeamDisplay> {
  ...
  late final Map<String, dynamic> generationsList;
  String currentGen = '1-151';
  ...
  void initGenList() async {
    final generations = await PokemonService().getGenerations();
    setState(() {
      ...
      children: [
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: ListWheelScrollView(
                                    ...
                                    itemExtent: 50,
                                    children:
                                        makePokemonListView(snapshot.data)),
                              )
                            ],
                          ))
                    ],
        ...
        Row(
          ...
          children: const [
            ...
            MenuTextBox(
              title: "Get Ranked",
              changeTo: ScreenLayout.ratedTeamDisplay,
              widthFactor: 0.45,
            )
          ],
        )
